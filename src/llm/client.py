...
class LLMClient:
    ...
    def _build_prompt(self, query: str, context: str) -> str:
        ...
        Example tone:
        - Instead of: "According to the information provided..."
        - Say: "Great question! To create an account, you can..."
        - Or: "I'd be happy to help! Here's how you can..."
        
        Remember: Be helpful, friendly, and make the user feel supported!
        """
